...
export default function UserSite() {
    ...
    fetch(`https://web-creator-umit.onrender.com/user/${slug}`)
      ...
      .then((data) => {
        ...
        try {
          ...
          if (typeof data.feedbacks === "string") {
  ...
  if (!data) return <div className="p-6">❌ User data not found.</div>;
  ...
  return (
    <div
      ...
      style={{
        ...
        color: data?.theme?.primaryColor || "#000",
      }}
    >
      <header className="mb-10 border-b pb-6">
        ...
        <p>
          Contact: {data.mobile_number} | {data.email}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {data.products && data.products.length ? (
            data.products.map((p, i) => (
              <div
                key={i}
                className="border rounded p-4 shadow-lg hover:shadow-2xl transition"
              >
